...
/* Definitions for LEDtTask */
osThreadId_t LEDtTaskHandle;
const osThreadAttr_t LEDtTask_attributes = {
  .name = "LEDtTask",
  .stack_size = 128 * 4,
...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the thread(s) */
  /* creation of LEDtTask */
  LEDtTaskHandle = osThreadNew(LED_Task, NULL, &LEDtTask_attributes);
...
/**
  * @brief  Function implementing the LEDtTask thread.
